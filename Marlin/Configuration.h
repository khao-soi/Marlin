...
#define STRING_SPLASH_LINE2 "Welcome to Kossel FaMi-Mod"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Kossel FaMi-Mod"
...
#define TEMP_RESIDENCY_TIME 3  // orig: 10 (seconds)
#define TEMP_HYSTERESIS 5       // orig: 3 (degC) range of +/- temperatures considered "close" to the target one
#define TEMP_WINDOW     5       // orig: 1 (degC) Window around target to start the residency timer x degC early.
...
// TODO: this is the values from ultibots - also defined in temperature.h
...
// UltiBots 200W 24V 240mm diam Kapton heater on 1.6mm aluminum spreader with 3.3mm Borosilicate glass.
    #define  DEFAULT_bedKp 217.79
    #define  DEFAULT_bedKi 37.34
    #define  DEFAULT_bedKd 317.57
  #endif
...
#define DELTA
  ...
  #define DELTA_TOWER_ANGLE_TRIM { 0.07, -0.39, 0.32 } // get these values from auto calibrate
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING Z_MIN_ENDSTOP_INVERTING //TODO: is that right?
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 800}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {4500,4500,4500,500}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
...
#define MIN_SOFTWARE_ENDSTOPS //TODO: set to true?
...
#define MAX_SOFTWARE_ENDSTOPS //TODO: set to true?
